/*----------------------------------------------
Programmer: Peter Woodsum (pnw8434@rit.edu)
Date: 06/29/2017
----------------------------------------------*/
...
class Application
{
	std::vector<vector3> m_vStopList;
	uint m_uCurrentStop = 0;
	uint m_uTotalStops = 0;
	Model* m_pModel = nullptr; //Model to try
	vector3 m_v3CurrentPos = vector3(0.0f, 0.0f, 0.0f);
	bool m_bRotating = false;
	float m_fRotation = 90.0f;
	float m_fMapTracker = 0.0f;
...
#pragma region Constructor / Run / Destructor
	...
	*/
	...
	OUTPUT: ---
	*/
	void Init(String a_sApplicationName = "EX01 - Practical", int a_uSize = BTO_RESOLUTIONS::RES_C_1280x720_16x9_HD, 
